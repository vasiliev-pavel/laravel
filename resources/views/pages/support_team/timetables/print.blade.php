...
<head>
    <title>Расписание - {{ $ttr->name.' - '.$ttr->year }}</title>
    <style>
        @media print {
    ...
    <div class="container">
        <div id="print" xmlns:margin-top="http://www.w3.org/1999/xhtml">
            ...
            <table width="100%">
                <tr>
                    <td>
                        <strong><span style="color: #1b0c80; font-size: 25px;">Расписание</span></strong><br />
                        <br /> <br />
                        <strong><span style="color: #000; font-size: 15px;"> Расписание для {{ strtoupper($my_class->name. ' ('.$ttr->year.')' ) }}
                            </span></strong>
                    </td>
                </tr>
            </table>
            ...
            <table cellpadding="20" style="width:100%; border-collapse:collapse; border: 1px solid #000; margin: 10px auto;" border="1">
                <thead>
                    <tr>
                        <th rowspan="2">Время <i class="icon-arrow-right7 ml-2"></i> <br> Дата<i class="icon-arrow-down7 ml-2"></i>
                        </th>
