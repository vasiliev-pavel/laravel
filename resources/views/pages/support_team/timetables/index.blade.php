...
@section('page_title', 'Управление расписаниями')
@section('content')

<div class="card">
    <div class="card-header header-elements-inline">
        <h6 class="card-title">Управление расписанием</h6>
        {!! Qs::getPanelOptions() !!}
    </div>
    ...
    <div class="card-body">
        <ul class="nav nav-tabs nav-tabs-highlight">
            @if(Qs::userIsTeamSA())
            <li class="nav-item"><a href="#add-tt" class="nav-link active" data-toggle="tab">Создать расписание</a></li>
            @endif
            <li class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Показать расписание</a>
                ...
                <div class="col-md-8">
                    <form class="ajax-store" method="post" action="{{ route('ttr.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input name="name" value="{{ old('name') }}" required type="text" class="form-control" placeholder="Название работы">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                               ...
                               <div class="col-lg-9">
                                   <select class="select form-control" name="exam_id" id="exam_id">
                                       <option value="">Список работ</option>
                                       @foreach($exams as $ex)
                        ...
                        <div class="text-right">
                            <button id="ajax-btn" class="btn btn-primary">Создать расписание<i class="icon-paperplane ml-2"></i></button>
                        </div>
                    </form>
                </div>
                            ...
                            <td class="text-center">
                                <div class="list-icons">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            {{--View--}}
                                            <a href="{{ route('ttr.show', $ttr->id) }}" class="dropdown-item"><i class="icon-eye"></i> Просмотр</a>

                                            @if(Qs::userIsTeamSA())
                                            {{--Manage--}}
                                            <a href="{{ route('ttr.manage', $ttr->id) }}" class="dropdown-item"><i class="icon-plus-circle2"></i> Управление</a>
                                            {{--Edit--}}
                                            <a href="{{ route('ttr.edit', $ttr->id) }}" class="dropdown-item"><i class="icon-pencil"></i> Редактировать</a>
                                            @endif

                                            {{--Delete--}}
                                            @if(Qs::userIsSuperAdmin())
                                            <a id="{{ $ttr->id }}" onclick="confirmDelete(this.id)" href="#" class="dropdown-item"><i class="icon-trash"></i> Удалить</a>
