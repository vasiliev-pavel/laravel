...
class SettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ['type' => 'current_session', 'description' => '2022-2024'],
            ['type' => 'system_title', 'description' => ''],
            ['type' => 'system_name', 'description' => 'Система учета учащихся'],
            ['type' => 'term_ends', 'description' => '7/10/2022'],
            ['type' => 'term_begins', 'description' => '7/10/2022'],
            ['type' => 'phone', 'description' => ''],
            ['type' => 'address', 'description' => ''],
            ['type' => 'system_email', 'description' => 'test@test.com'],
